	...
	<g fill="none" stroke-width="4">
		...
		<path class="dashed2" stroke="white" stroke-dasharray="5, 5" d="M5 20 l215 0" />
						...
						<p class="heading-paragraph">You can order our services from anywhere,
							use them anywhere and also
							get help in where ever you are! Our
							customer service and dedicated developer
							team is always up and
							ahead to serve you and solve your
							any issue 24x7</p>
					</div>
								...
								<div class="service-box-layout1">
									<div class="icon-holder icon-bg-royal-blue">
										<div class="item-icon icon-color-royal-blue">
											<i class="flaticon-motherboard"></i>
										</div>
