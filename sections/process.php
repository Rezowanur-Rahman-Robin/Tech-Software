			...
			<section class="process-wrap-layout1 section-padding-md bg-color-light position-relative">
				<div class="container">
					<div class="section-heading heading-dark heading-layout1 has-animation">
						<h2 class="heading-main-title">How We Work</h2>
		...
		<path class="dashed2" stroke="white" stroke-dasharray="5, 5" d="M5 20 l215 0" />
				...
				<div class="container-fluid">
					<div class="row d-flex align-items-center">
						...
						<div class="col-xl-12 col-12 order-xl-1 compress-left-side has-animation">
										...
										<div class="translate-right-75 transition-150 opacity-animation transition-delay-100 mb-4">
											<div class="d-flex align-items-sm-center process process">
												...
												<div class="item-content">
													<h3 class="item-title">Prepare Requirements Collection</h3>
												...
												<div class="translate-right-75 opacity-animation transition-150 transition-delay-2600">
													<div class="main-banner-box-layout1">
														<div class="item-figure">
															<img  src="media/illustration/illustration1.png" alt="Illustration" style="max-width: 345px; max-height: 200px;">
														</div>
													</div>
												</div>
										</div>
									...
									<li>
										...
										<div class="translate-left-75 transition-150 opacity-animation transition-delay-1000 mb-4">
											<div class="d-flex align-items-sm-center process flex-xl-row-reverse">
												...
												<div class="item-content">
													<h3 class="item-title">Think about UI/UXDesign</h3>
													<p>Grursus mal suada faci lisis Lorem ipsum the and dolarorit more ametion have to elit. </p>
												</div>
									...
									<li>
										<div class="translate-right-75 transition-150 opacity-animation transition-delay-2000 mb-4">
											<div class="d-flex align-items-sm-center process">
												...
												<div class="item-content">
													<h3 class="item-title">Focus on Coding</h3>
													<p>Grursus mal suada faci lisis Lorem ipsum the and dolarorit more ametion have to elit. </p>
												</div>
												...
												<div class="translate-right-75 opacity-animation transition-150 transition-delay-2600">
													<div class="main-banner-box-layout1">
														<div class="item-figure">
															<img  src="media/illustration/illustration16.png" alt="Illustration" style="max-width: 345px; max-height: 200px;">
														</div>
													</div>
												</div>
									...
									<li>
										<div class="translate-left-75 transition-150 opacity-animation transition-delay-1000 mb-4">
											<div class="d-flex align-items-sm-center process flex-xl-row-reverse">
												...
												<div class="item-content">
													<h3 class="item-title">Review your product with QA Stage</h3>
													<p>Grursus mal suada faci lisis Lorem ipsum the and dolarorit more ametion have to elit. </p>
												</div>
												...
												<div class="translate-right-75 opacity-animation transition-150 transition-delay-2600">
													<div class="main-banner-box-layout1">
														<div class="item-figure">
															<img  src="media/illustration/illustration29.png" alt="Illustration" style="max-width: 345px; max-height: 200px;">
														</div>
													</div>
												</div>
							...
							<li>
								<div class="translate-right-75 transition-150 opacity-animation transition-delay-2000 mb-4">
									<div class="d-flex align-items-sm-center process">
										...
										<div class="item-content">
											<h3 class="item-title">Care about your product with Operations stage</h3>
											<p>Grursus mal suada faci lisis Lorem ipsum the and dolarorit more ametion have to elit. </p>
										</div>
										...
										<div class="translate-right-75 opacity-animation transition-150 transition-delay-2600">
											<div class="main-banner-box-layout1">
												<div class="item-figure">
													<img  src="media/illustration/illustration31.png" alt="Illustration" style="max-width: 345px; max-height: 200px;">
												</div>
											</div>
										</div>
