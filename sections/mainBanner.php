						...
						<div class="col-lg-7 order-lg-1 compress-left-side d-flex align-items-center">
							<div class="main-banner-box-layout1">
								<div class="translate-bottom-75 opacity-animation transition-150 transition-delay-1500">
									<div class="item-sub-title">Software Design &amp; Development</div>
								</div>
								<div class="translate-bottom-75 opacity-animation transition-150 transition-delay-1800">
									<h1 class="item-main-title-wetech">We Tech </h1><h1 class="item-main-title" style="display:inline;">Technology Solutions and Services</h1>
								</div>
								<div class="translate-bottom-75 opacity-animation transition-150 transition-delay-2100">
									<p>We Tech is the first and one of kind
										company who brought management software and
										application to the mobile platform in this region.
										We Tech is also one of the few companies who works
										with real-time servers for data synchronization.</p>
								</div>
