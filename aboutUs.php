...
<!-- Mirrored from www.radiustheme.com/demo/html/digeco/digeco/about2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Aug 2021 21:42:35 GMT -->
<head>
	<!-- Meta Data -->
	<meta charset="UTF-8">
...
<body>
	...
	<div id="wrapper" class="wrapper">
        ...
        ?>
			...
			<!--=====================================-->
			<section class="section-padding-bottom-md about-wrap-layout10 has-animation mt-5">
				<div class="container">
						...
						<div class="col-lg-6 col-12">
							<div class="about-box-layout10">
								<div class="figure-holder">
									<div class="translate-right-75 opacity-animation transition-200 transition-delay-1700">
										<img src="media/about/about5.png" alt="About">
									</div>
								</div>
							</div>
						</div>
			...
			<section class="feature-wrap-layout9 section-padding-md-equal">
				<div class="container">
					<div class="section-heading heading-dark heading-layout4">
						<div class="heading-sub-title">Our company</div>
						<h2 class="heading-main-title">Solve Your Problem With Very Faster</h2>
					</div>
							...
							<div class="translate-left-75 opacity-animation transition-200 transition-delay-10">
								<div class="feature-box-layout9">
									<div class="item-figure">
										<img src="media/feature/feature10.png" alt="Feature">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="translate-bottom-75 opacity-animation transition-200 transition-delay-10">
								<div class="feature-box-layout9">
									<div class="item-content">
										...
										<p>In WE TECH, we are dedicated to our work and always sticking to ethical decisions.</p>
										<ul class="list-item">
											<li class="icon-bg-dodger-blue-2">
												<div class="item-icon">
...
<!-- Mirrored from www.radiustheme.com/demo/html/digeco/digeco/about2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Aug 2021 21:42:36 GMT -->
</html>