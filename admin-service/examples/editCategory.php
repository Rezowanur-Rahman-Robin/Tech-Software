...
$get_target_cat= "select * from category where cat_id=$target_cat_id";
$run_target_cat= mysqli_query($con,$get_target_cat);

if($row_target_cat = mysqli_fetch_array($run_target_cat)){
       $target_cat_title= $row_target_cat['cat_title'];
}
...
<form action="" class="form-horizontal" method="post">
    ...
    color: white;" for="cat_title">Cateogy Title:</label>
      <input type="text" class="form-control"  value="<?php echo $target_cat_title; ?>" name="cat_title" required>
    </div>
   
    <input type="submit" value="Update" name="cat_update" class="btn btn-primary"/>
</form>
        ...
        if(isset($_POST['cat_update'])){
          ...
          $insert_cat = "update category set cat_title ='$cat_title' where cat_id=$target_cat_id";
          $run_cat =mysqli_query($con,$insert_cat);

          if($run_cat){
                  
            echo "<script>alert('Your Category Has Been Updated Successfuly')</script>";
            echo "<script>window.open('editCategory.php?category_id=$target_cat_id','_self')</script>";
            
        }
        else
        {
          echo "<script>alert('Your Category Update Failed!')</script>";
