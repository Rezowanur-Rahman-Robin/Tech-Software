...
<form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
    ...
    color: white;" for="t_name">Team Member Name:</label>
      <input type="text" class="form-control"  placeholder="Enter team member name" name="t_name" required>
    </div>
    ...
    background: white;
    border-radius: 9px;
    padding: 4px;"  class="ml-2" name="t_img" type="file" required>
...
<div class="form-group"  >
    ...
    color: white;" for="t_role">Team member Position:</label>
      <input type="text" class="form-control"  placeholder="Enter team member position" name="t_role" required>
</div>
...
<div class="form-group"  >
    ...
    color: white;" for="t_fb">Team member Facebook link:</label>
      <input type="text" class="form-control"  placeholder="Enter fb link" name="t_fb" >
</div>

<div class="form-group"  >
      <label style=" font-weight: 1000;
    color: white;" for="t_twitter">Team member Twitter link:</label>
      <input type="text" class="form-control"  placeholder="Enter twitter link" name="t_twitter" >
</div>
...
<div class="form-group"  >
    ...
    color: white;" for="t_instragram">Team member Instragram link:</label>
      <input type="text" class="form-control"  placeholder="Enter instragram link" name="t_instragram" >
</div>
    ...
    <input type="submit" value="Submit" name="submit" class="btn btn-primary"/>
        ...
        if(isset($_POST['submit'])){
          ...
          $insert_team = "insert into teams (t_name,t_role,t_img,t_fb,t_twitter,t_instragram)
           values ('$t_name','$t_role','$t_img','$t_fb','$t_twitter','$t_instragram') ";
          $run_team =mysqli_query($con,$insert_team);

          if($run_team){
                  
            echo "<script>alert('Your New Team Member Has Been Inserted Successfuly')</script>";
            
        }
        else
        {
          echo "<script>alert('Your New Team Member Insertion Failed!')</script>";
